...
def check_auth(baseUrlNoPrefix, useHttps, authUri, username, password):
...
class Server(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        httpResp = check_auth(self.baseUrl, self.useHttps, self.authUri, self.username, self.password)
